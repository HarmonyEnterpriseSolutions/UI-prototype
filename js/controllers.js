/**
 * Created by markel on 10.06.15.
 */


var Harmony = angular.module('Harmony', ['ngTouch', 'ui.grid']);

Harmony.controller('MainController', ['$scope', '$http', 'uiGridConstants', function ($scope, $http, uiGridConstants) {
  var today = new Date();
